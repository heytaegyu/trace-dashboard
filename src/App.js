    ...
    <div style={{ fontFamily: "'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif", background: "#f8fafc", minHeight: "100vh" }}>
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #e5e7eb", padding: isMobile ? "16px 20px 0" : "20px 32px 0" }}>
        <div style={{
          ...
          <div>
            ...
            <h1 style={{ fontSize: isMobile ? 18 : 20, fontWeight: 800, margin: 0, color: "#0f172a" }}>
              2026 WBR 대시보드
            </h1>
          </div>
      ...
      <div style={{ padding: isMobile ? "20px 16px" : "28px 32px", maxWidth: 900, margin: "0 auto" }}>
        ...
        {tab === "현황" && (
          <div>
            {/* 목표 달성 배너 */}
            <div style={{ background: "#fff", borderRadius: 14, padding: isMobile ? "20px 18px" : "24px 28px", marginBottom: 20, border: "1px solid #e5e7eb", boxShadow: "0 1px 3px #00000008" }}>
              <div style={{
                display: "flex",
                flexDirection: isMobile ? "column" : "row",
                justifyContent: "space-between",
                ...
                <div>
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap" }}>
                    ...
                    <span style={{ fontSize: isMobile ? 15 : 14, color: "#9ca3af" }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: isMobile ? 28 : 22, fontWeight: 900, color: "#ef4444" }}>
          ...
          <div>
            ...
            {isMobile ? (
              <div style={{ marginBottom: 20 }}>
                <div style={{ fontSize: 14, fontWeight: 700, color: "#0f172a", marginBottom: 14, padding: "0 2px" }}>주간 지표 상세</div>
                {kpiData.map((r, i) => (
                  <div key={i} style={{
                    background: "#fff",
                    borderRadius: 14,
                ...
                {/* 평균 카드 */}
                <div style={{ background: "#f8fafc", borderRadius: 14, padding: "18px 18px", border: "2px solid #e5e7eb" }}>
                  <div style={{ fontSize: 14, fontWeight: 800, color: "#374151", marginBottom: 14 }}>평균</div>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px 16px" }}>
                    <div>
                      <div style={{ fontSize: 11, color: "#9ca3af", marginBottom: 3 }}>순판매량</div>
                      <div style={{ fontSize: 16, fontWeight: 700, color: "#374151" }}>{avgSales}개</div>
                    </div>
                    <div>
                      <div style={{ fontSize: 11, color: "#9ca3af", marginBottom: 3 }}>기여이익</div>
                      <div style={{ fontSize: 16, fontWeight: 700, color: "#374151" }}>{(avg("기여이익")/10000).toFixed(1)}만</div>
                    </div>
                    <div>
                      <div style={{ fontSize: 11, color: "#9ca3af", marginBottom: 3 }}>판매이익</div>
                      <div style={{ fontSize: 16, fontWeight: 700, color: "#8b5cf6" }}>{(avgProfit/10000).toFixed(1)}만</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {tab === "전략" && (
          <div>
            <div style={{
              ...
              <div style={{ background: "#fff", borderRadius: 14, padding: "22px 22px", border: "1px solid #fee2e2" }}>
              ...
              <div style={{ background: "#fff", borderRadius: 14, padding: "22px 22px", border: "1px solid #d1fae5" }}>
                    ...
                    {[
                      ...
                      <div key={i} style={{ display: "flex", alignItems: "center", gap: 14 }}>
                        ...
                        <div style={{ display: "flex", gap: 10, alignItems: "baseline", padding: "6px 0" }}>
                          <span style={{ fontSize: 12, color: "#9ca3af", minWidth: 36 }}>{s.label}</span>
